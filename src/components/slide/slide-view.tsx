...
export function SlideView({ slide, templateOverride }: SlideViewProps) {
  ...
  return (
    <div
      className="relative w-full h-full overflow-hidden slide"
      style={{
    ...
    >
      <style>{layoutDesigns.baseCss}</style>
