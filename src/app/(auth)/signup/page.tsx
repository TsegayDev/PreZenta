...
export default function SignUpPage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    console.log(values);
    setTimeout(() => {
      alert('Signed up successfully! (Check console for values)');
      setIsLoading(false);
    }, 1500);
  }
  ...
  return (
    <Card className='rounded'>
      <CardHeader>
        ...
        <CardDescription>
          Get started with AI-powered presentations today.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <Button variant="outline" className="rounded w-full" type="button" onClick={onGoogleSignUp} disabled={!!isLoading}>
